    ...
    internal class Shop
    {
        ...
        public void PrintProds(Products[] Prods)
        {
            if(Prods != null)
            {
                ...
                for (int i = -2; i < Prods.Length; i++)
                {
                    if (i == -2)
                    {
                        int len = nameLength + priceLength + countLength + 2;
                        Console.Write("+");
                        for (int l = 0; l < len; l++) Console.Write("-");
                        Console.Write("+\n");
                        Console.Write("|");
                        for (int l = 0; l < (len - Prods[0].Type.Length)/2; l++) Console.Write(" ");
                        Console.Write(Prods[0].Type);
                        for (int l = 0; l < ((len - Prods[0].Type.Length)/2 + (len%2 != Prods[0].Type.Length%2 ? 1 : 0)); l++) Console.Write(" ");
                        Console.Write("|\n");
                    }
                    else if (i == -1)
                    {
                    ...
                    {
                        for (int k = 0, l = 0; k < Prods.Length * 2; k++)
                        {
                            if (k % 2 == 1)
                            {
                                Console.Write("+");
